...
- ⚠️ **main 上有一条已知真红**：run 35899227852（main@c8cbd24）的 E2E job 红在
...
- 本地已知噪声：`period-anchor` A2 本机负载下约 1/3 红（见上条，已升级为待查项而非噪声）
- 下一项：#66 A2 真红定性（产品态还是手势）→ #199 口径裁定与实现 → #56 价格轴自适应的测试面
- 更新日：2026-09-24
