...
- main 现状：**v0.5.32 已发布**（tag `v0.5.32` @ c8cbd24），其后合入 **#198 → a4b653f**
- 待合并：
  - **#200**（收口 issue **#193**）一条 webkit/真浏览器抽测反复红过的链，根因**不在**十字光标：
...
- 门禁现状（main@a4b653f + #200 工作区）：`npm test` → **2030 passed / 175 files**（#198 +1、#200 +4）；
  `node scripts/run-ci-e2e.mjs --list` → **426 tests in 20 files**（新增 `e2e/period-resnap.spec.ts` 三条）；
  #198 的 CI 三浏览器 E2E 全绿（run 35900507623）
...
- 下一项：#202 A2 真红定性（产品态还是手势）→ #199 口径裁定与实现 → #56 价格轴自适应的测试面
- 更新日：2026-09-24
