...
| [09-FIX协议详解.md](09-FIX协议详解.md) | FIX 协议是什么、消息结构（Tag=Value 与校验和）、核心消息类型、Session 生命周期、订单状态与 ExecType、优缺点与选型、FAST 与加密交易所现状 |
| [10-CTP对接实战.md](10-CTP对接实战.md) | CTP 是什么、环境准备（仿真与生产）、开发流程、回调线程模型、流控与限频、重连与结算单确认、Python 最小框架示例、常见坑清单 |
| [11-撮合引擎原理.md](11-撮合引擎原理.md) | 撮合规则（价格/时间优先）、订单簿数据结构与增量更新、撮合算法（连续竞价/集合竞价）、做市与涨跌停排队、交易所撮合 vs 区块链 AMM、撮合引擎设计要点 |
