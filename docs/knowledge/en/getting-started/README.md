...
- After finishing this chapter, continue along the knowledge-base roadmap: [Spot](../spot/) (the easiest entry) → [Stocks](../stocks/) → [Futures](../futures/).
