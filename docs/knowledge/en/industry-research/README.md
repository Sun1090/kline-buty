...
> master the industry and stock analysis finally has an anchor. This chapter teaches you to build your own industry research framework.
...
① Industry Research Methodology (set up the framework first)
   ↓
② Value Chain Analysis (split the industry into upstream/midstream/downstream and find the money)
   ↓
③ Competitive Landscape & Economic Moats (read the power relations among players)
   ↓
④ Sector Prosperity & Cycles (judge where the industry stands right now)
   ↓
⑤ New Tracks & Theme Investing (handle the hottest, most dangerous part)
```

- ① is the master outline; ②③④ are three overlapping specialized lenses — order is flexible, but reading in sequence is recommended.
- ⑤ depends on the foundation of ①②③④: without an industry framework, theme investing is running naked.
- After finishing this chapter, continue with [Chapter 04: Stocks](../stocks/) (company financials and valuation) and [Chapter 18: Financial Deep Dive](../financial-statements/) (going deeper on individual stocks).

---

## Conventions

- This chapter covers research methodology only. Companies, data, and prices in examples are illustrative fiction or historical cases, do not reflect current facts, and constitute no investment advice.
- Sections involving risk include a "⚠️ Risk Warning" box. **No methodology, however complete, eliminates risk — it only lowers the odds of stepping on a mine.**
- For industry data, defer to the latest disclosures from industry associations, national statistics bureaus, exchanges, and listed companies.

---

## Article Cards

<DocCards dir="industry-research" />
