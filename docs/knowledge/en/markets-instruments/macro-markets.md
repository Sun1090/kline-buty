...
| **Hiking/cutting cycles** | Consecutive rate rises/falls | Hiking cycles suppress all risk assets; cutting cycles open the door to **<mark>liquidity</mark>** easing |
...
::: danger 💀 Data moments are a meat grinder for the heavily positioned
**The 10 minutes before and 30 minutes after a release are the most violent window and a prime wick-hunting period.** Keep pending orders and heavy positions away from data moments — wicks sweeping orders at the instant of NFP, CPI, or FOMC releases are the most common **<mark>blow-up</mark>** mode for the heavily positioned.
:::
...
- **Recession**: the central bank is forced into big cuts; long bonds (the longer the **<mark>duration</mark>**, the bigger the gain) fare best — the golden era for bond investors.
...
::: warning ⚠️ Gold is not a no-brainer haven
...
::: warning ⚠️ In a retail-dominated market, emotional impulses end in bag-holding
...
|---|---|---|
| **VIX fear index** | S&P 500 option **implied volatility** (see [05 - Indexes and Sectors](indices-sectors.md)) | >30 panic, <15 complacency; extremes are often contrarian signals |
| **Margin balance (two-financing)** | The total retail borrowings to buy stocks domestically | Rising with the index = **<mark>leverage</mark>** bull; rapid contraction = deleveraging decline risk |
...
| **US 10-year yield** | The "anchor" of global asset pricing (see [02 - Bonds and Interest Rates](bonds-interest-rates.md)) | Rapidly rising yields = global risk assets pressured; falling = easing expectations |
...
::: tip 💡 Sentiment indicators flag crowding, not direction
