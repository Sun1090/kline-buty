...
- Equal-weighted indexes usually **outperform in mid-to-late bull markets** (small names catch up) but fare worse in **<mark>drawdowns</mark>**.

### Constituents and rebalancing

- **Constituents**: index companies select members by rules (market-cap rank, **<mark>liquidity</mark>**, industry spread). For example, CSI 300 = the top 300 Shanghai/Shenzhen stocks by cap (with liquidity screening and other details).
...
::: warning ⚠️ The SSE Composite is not all of A-shares
...
- **CSI 1000 / CNI 2000 map to index futures/options**: CFFEX IC and IM are tied to CSI 500 and CSI 1000, so small-cap styles can be **<mark>hedged</mark>** directly (see [03 - Futures / 04 - Futures Products](../futures/futures-products.md)).
...
::: tip 💡 The Nasdaq is the most rate-sensitive
...
- Three forces drive the rotation:
  1. **The macro cycle**: in recovery, cyclicals (nonferrous, chemicals) rise first; in overheating, upstream resources (coal, oil) are strongest; in recession, defensives (utilities, pharma, consumer staples) hold up best.
  2. **Industry cycles**: policy-born mainlines (new energy, AI, Xinchuang) can run 1-3 years independent of the macro cycle.
  3. **Money and sentiment**: public fund launches, northbound flows, and hot-money theme switches drive short-term style strength.
...
- See [08 - Macro Economy and Markets](macro-markets.md), section "The Four Phases of the Economic Cycle", for more.
...
|---|---|---|
| Risk | Diversified; a single blow-up has limited impact | Concentrated; a delisting/scandal can **<mark>zero</mark>** the position |
...
::: tip 💡 The VIX is a contrarian indicator — others' panic is the best opportunity
...
1. An index does not mean "guaranteed gains": in 2008 the S&P 500 and in 2015 the CSI 300 both suffered halving-level drawdowns — index investing carries large loss risk too.
2. Index constituents and weights get rebalanced; past returns do not guarantee the future, and tracking error and fees of index funds affect actual returns.
3. Sector and style rotation is at heart a "timing" game; chasing hot sectors in and out is one of the main causes of losses.
4. All index compositions, constituent counts, weight caps, and rebalancing dates in this article follow the index companies' latest announcements.
