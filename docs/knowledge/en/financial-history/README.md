...
③ Trading Masters (then see who survived, and how)
   ↓
④ Trading Schools and Philosophy (finally, settle your own worldview)
```

- ① and ② are the "horror films": watch them before trading with real money — many people lose big precisely because they never studied history.
- Read ③ before [Chapter 07 - Trading System](../trading-system/): know how the masters died first, then study their methods.
...
<DocCards dir="financial-history" />
