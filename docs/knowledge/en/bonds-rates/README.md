...
- **Read [09-Markets & Instruments / 02-Bonds & Interest Rates](../markets-instruments/bonds-interest-rates.md) first**: this chapter assumes you already know bond pricing, the inverse price-yield relationship, and the concepts behind the risk-free rate and the yield curve.
- Readers interested in funds can pair it with [09 / 03-Funds & ETFs](../markets-instruments/funds-etf.md) for the QDII and bond fund sections.
- For details on Treasury ETFs and US brokerage practice, pair with [14-Wealth Allocation / 06-Overseas Asset Allocation in Practice](../wealth-allocation/overseas-allocation.md).
