...
::: warning ⚠️ Conclusion: Not Illegal Does Not Mean Risk-Free
For mainland Chinese residents, offshore crypto trading sits in a **<mark>regulatory gray zone</mark>** — "not illegal" does not mean "no risk": platform wind-downs, account freezes, and <mark>frozen bank cards</mark> during deposits/withdrawals are all real risks. Handling of small personal holdings varies by locality — **always defer to the latest rules and enforcement practice**.
:::

::: danger 💀 Not Illegal Does Not Mean Risk-Free
...
- Common-sense reminder: anything branded as "e-CNY investing" or "promotion rebates" is essentially a scam (see [Chapter 08 · Pitfalls](../pitfalls/)).
...
::: tip 💡 Key point: the consensus direction of stablecoin regulation
...
| Current | Unlicensed operation is a <mark>criminal offense</mark>; **unlicensed platforms marketing to the Hong Kong public must be removed/blocked** |

### 3.2 Licensing Requirements Basics

- Platforms must be **companies incorporated in Hong Kong**, pass suitability review, comply with <mark>AML</mark> (AMLO), and segregate client assets.
...
::: tip 💡 Practical meaning for mainland users
...
| Exchange licensing | Crypto asset exchange providers register with the Financial Services Agency (FSA); capital, internal control, custody, and <mark>KYC</mark> requirements apply |
...
The **<mark>Markets in Crypto-Assets Regulation</mark>** — the EU's unified crypto regulatory framework:
...
| Move funds through compliant channels | Refuse intermediaries offering "FX conversion deposits" — frozen-card and investigation risks covered in [Chapter 08 · Pitfalls](../pitfalls/) |
...
- Filing is fundamentally "bringing your assets into daylight": the cost of compliance is tax; the cost of evasion is penalties, interest, <mark>fines</mark>, even <mark>criminal liability</mark>.
...
- Product knowledge for crypto trading: [Chapter 05 · Crypto Perpetuals](../crypto-perpetuals/) and [crypto-spot.md](../spot/crypto-spot.md) in [Chapter 02 · Spot](../spot/)
- Frozen cards, fund flows, and AML risk in detail: [compliance-taxes.md](../pitfalls/compliance-taxes.md) in [Chapter 08 · Pitfalls](../pitfalls/)
- Crypto market manipulation and Ponzi identification: [scam-detection.md](../pitfalls/scam-detection.md) in [Chapter 08 · Pitfalls](../pitfalls/)
- Comparison with the US framework: [us-global-regulation.md](us-global-regulation.md)
