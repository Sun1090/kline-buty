...
- Read the trading fundamentals part of [Getting Started](../getting-started/) and the risk-control framework in [Trading Systems](../trading-system/) first — this chapter is the "information → decision" link in that chain.
- Pair the earnings-related articles with [Financial Statements Deep Dive](../financial-statements/): that chapter teaches you to read the statements themselves; this one teaches you to read the "talk" around them.
...
- After finishing this chapter, combine it with the "event-driven" framework in [Quantitative Practice](../quant-practice/) to harden data interpretation into a systematic part of your trading.

---

## Chapter Contents

<DocCards dir="data-interpretation" />
