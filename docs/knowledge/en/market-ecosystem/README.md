...
- ① is the foundation: everything that follows revolves around "participants."
- ② and ③ serve trade execution directly: which instruments, which hours, how to place orders.
- ④ and ⑤ are the "superstructure of information and rules": understanding the ecosystem's underlying motives keeps you from being harvested by it.
- ⑥ and ⑦ are "truths beyond the order book": players on the speed dimension and fills under the water remind you that the visible book is far from the whole story.

---

## Conventions

- All descriptions of manipulation, pool operations, and insider trading are for identification education only; such conduct is illegal in most jurisdictions. Do not imitate.
- Trading data, fee rates, and participant structures are generic teaching values; they vary across markets and years.
- This chapter pairs well with [08-Pitfalls](../pitfalls/) (scam recognition and avoidance).

---

## Chapter Contents

<DocCards dir="market-ecosystem" />
