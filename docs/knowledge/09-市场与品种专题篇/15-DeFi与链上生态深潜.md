...
> [07-加密货币全景.md](07-加密货币全景.md) 里讲过 DeFi 的框架性认知（CEX vs DEX、四种玩法、合约风险），本篇把它做一次**深潜实操**：不满足于「DeFi 是去中心化金融」这句话，而是把质押、借贷、流动性挖矿、收益聚合、跨链桥的**具体机制、数字账、风险开关**逐一拆开。
>
...
> ⚠️ 风险提示
>
> **DeFi 的风险等级显著高于中心化交易所。** 中心化交易所至少还有运营主体、客服与合规约束（虽然也并非绝对安全），而 DeFi 协议一旦部署就是「无人负责」的代码：合约漏洞、黑客攻击、脱锚、预言机操纵、Rug Pull（跑路）都会导致**本金直接归零且无任何追偿渠道**。文中所有利率、APY、TVL、安全事件金额均为教学口径的通用描述，**以最新链上数据/项目状态为准**。参与 DeFi 前，请务必评估自己能否承受本金的全部损失。

---

## 目录

- [① DeFi 全景：什么是去中心化金融](#①-defi-全景什么是去中心化金融)
- [② DeFi 四大玩法实操](#②-defi-四大玩法实操)
- [③ 跨链桥 Bridge](#③-跨链桥-bridge)
- [④ DeFi 风险全景](#④-defi-风险全景)
- [⑤ 普通人参与 DeFi 的入门路线](#⑤-普通人参与-defi-的入门路线)
- [⑥ DeFi 与交易：链上利率是市场情绪的温度计](#⑥-defi-与交易链上利率是市场情绪的温度计)
- [风险提示](#风险提示)
...
**DeFi（Decentralized Finance，去中心化金融）**：在区块链（主要是以太坊）上用智能合约自动执行**借贷、交易、衍生品**等金融业务的系统。它的核心特征不是「收益率高」，而是**无中介**：
...
- **清算机制**：任何用户（清算机器人）都能在触发清算时帮你「还债 + 打折买走抵押品」——**清算是 DeFi 无托管的「自动止损」，且清算人抢先机赚差价**，被清算者损失比传统强平更「吃暗亏」。
...
**无常损失（Impermanent Loss）**：你放进池子里的两币，因为两者价格背离，导致**取出的总价值比「一直捏着不提供流动性」更少**。币价差得越远，损失越大。
...
>
> **结论：DeFi 的「长期年化」再漂亮，也扛不住「一次爆雷本金归零」**。这也是为什么 DeFi 仓位必须小、协议必须头部、本金必须是「归零也无所谓」的钱。
...
链上协议不只是「理财产品」，它的利率数据本身就是**观察市场资金情绪的高频指标**，与合约交易的资金费率（参考 [05-加密合约篇/02-资金费率.md](../05-加密合约篇/02-资金费率.md)）互为补充：
