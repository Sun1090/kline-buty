---
title: 01 · 行业研究方法论
description: 研究个股前先研究行业，这是卖方研究员的第一课，也是散户最稀缺的一课
---
...
| 现在处于什么位置？ | 景气度与周期 | 处在周期哪一段？**<mark>渗透率</mark>**到哪了？催化因素是什么？ |

::: warning ⚠️ 不回答这四个问题，个股分析就是无锚之舟
...
- 某光伏行业：空间仍大但增速换挡、格局恶化（**<mark>产能过剩</mark>**、**<mark>价格战</mark>**）、重资产、处于产能出清期。
...
| HHI（赫芬达尔指数） | 各玩家**<mark>市占率</mark>**平方之和 | > 2500 高度集中，< 1500 分散（详见 03 篇） |
| 市占率变化 | 龙头份额的年度增减 | 份额持续提升 = 格局向龙头收敛 |

### ③ 产业链位置与议价能力

- 行业在产业链中处于上游、中游还是下游？面对供应商与客户的议价能力如何？
- 上下游集中度对比：**<mark>如果上游更集中、下游更分散，中游的利润空间最容易两头被挤。</mark>**
...
- **<mark>催化剂是"何时启动"的信号，前四步是"值得不值得"的依据，顺序不能反。</mark>**
...
| 标准 | 反例行业（举例说明） | 为什么不好 |
|---|---|---|
| 永续需求 | 传统胶卷 | 需求被数码技术整体替代，行业**<mark>归零</mark>** |
...
::: warning ⚠️ 反直觉：好行业是动态筛选出来的，不是背下来的
...
| 价格数据 | 卓创资讯、Wind、上海有色网、钢联等 | 产品价格、**<mark>价差</mark>**、库存的实时与历史序列 |
...
以当前格局外推十年，是最危险的习惯。光伏替代火电、电动车替代燃油车、智能手机替代功能机——每一轮替代里，原行业的"龙头格局"都是最脆弱的资产。**<mark>研究行业时必须问一句：有没有可能被新技术整体绕过？</mark>** 你的行业如果处在被替代的赛道上，格局再稳定也没用。
...
::: warning ⚠️ 风险提示
行业研究是提高**<mark>胜率</mark>**的工具，不是保证盈利的武器。空间测算可能有严重偏差（尤其新赛道），格局可能被技术或政策一夜改写，景气判断可能被黑天鹅打脸，行业数据存在滞后与口径水分。方法论再完备，也不能消灭行业轮动与系统性风险。本文为方法论科普，不构成任何投资建议；**研究得再深，也要用**<mark>仓位</mark>**与**<mark>止损</mark>**来面对不确定性。**
:::
