---
title: 05 · 期权工具与复盘：会用工具，才能把经验变成资产
description: 期权交易拼的不只是知识，还有信息获取与经验沉淀。同一张期权链，老手读出 IV 分位、OI 增减、主力行权价分布，新手只看到一堆价格
---
...
| **<mark>Delta</mark>/<mark>Gamma</mark>/<mark>Theta</mark>/<mark>Vega</mark>** | 各合约的希腊字母 | 选合适合约、估算暴露 |
...
| 功能 | 说明 |
|---|---|
| **预设策略模板** | **<mark>跨式</mark>**/**<mark>铁鹰</mark>**/**<mark>价差</mark>**等一键插入，自动填腿 |
| **盈亏图（P/L 图）** | 可视化到期盈亏曲线、当前盈亏、盈亏平衡点 |
| **风险参数** | 实时展示组合的 Delta/Gamma/Theta/Vega/最大亏损/**<mark>保证金</mark>** |
...
| **入场细节** | 行权价 / 到期日 / **<mark>权利金</mark>** / 希腊字母暴露（Delta/Gamma/Theta/Vega） |
...
::: warning ⚠️ 模拟盘的两个提醒
① 模拟盘**没有真金白银的压力**，练技术可以，练心态要打折扣；② 模拟盘**<mark>点差</mark>**/成交假设常比实盘好，**模拟赚钱 ≠ 实盘赚钱**。它的价值是「把策略盈亏图画熟、把检查清单走熟」。
:::
