...
> **内容边界**：本篇是 DeFi 的机制与风险正篇，覆盖质押、借贷、流动性挖矿、收益聚合、跨链桥及链上核查。入门级的 CEX/DEX、钱包、稳定币和市场版图只在 [07-加密货币全景](crypto-landscape.md) 与 [03-加密现货专题](../spot/crypto-spot.md) 中作导航，不在此重复展开。

---

> **⚠️ 风险提示**
>
> **DeFi 的风险等级显著高于中心化交易所**：协议一旦部署就是「无人负责」的代码，各类事故都会导致**本金直接**<mark>归零</mark>**且无任何追偿渠道**。参与前请先读文末完整风险提示，并评估自己能否承受本金的全部损失。
