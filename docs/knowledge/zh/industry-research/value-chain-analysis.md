...
产业链研究的核心命题只有一个：**<mark>钱从哪来、流到谁手里、未来会流到哪里去。</mark>** 景气上行时利润往往先到最缺产能的环节，下行时利润留在议价权最强（离需求端最近或有垄断地位）的环节——研究产业链，就是跟踪利润的流动方向。
...
| 环节 | 代表公司类型 | 当前利润特征 |
|---|---|---|
| 上游 | 锂矿、钴镍、正极/负极/电解液/隔膜 | 价格周期剧烈，2021-2022 暴利，**<mark>产能过剩</mark>**后回落 |
...
- **竞争充分**：谁都能干，**<mark>价格战</mark>**必然压低利润。
- **两头受挤**：上游核心部件要涨价、下游品牌要压价，代工环节被动接受。
- 现实写照：顶级代工企业净利率常在 3%-6%，而品牌与核心部件的净利率往往是它的数倍。

> 用**<mark>微笑曲线</mark>**做投资判断：**在同等质地下，产业链里越靠近"嘴角"（设计/品牌两端）的公司，越有<mark>护城河</mark>溢价；越靠近"下巴"（制造组装）的公司，越依赖规模与效率。** 当然，例外也存在——制造端若能做出独特工艺壁垒（如精密制造、独家材料），也能离开曲线底部。
...
产业链上总有某个环节是"瓶颈"——别人都在等它的产能，它掌握定价权。**<mark>卡点 = 利润率最高的环节 = 议价权最强的地方。</mark>**
