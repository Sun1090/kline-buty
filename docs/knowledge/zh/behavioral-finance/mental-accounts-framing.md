---
title: 04 · 心理账户与框架效应
description: 塞勒（Richard Thaler，2017 年诺贝尔经济学奖得主）问了一个朴素的问题：100 块工资里的 100 块，和 100 块彩票赢来的 100 块，是同一张钱吗？ 理性人…
---

# 04 · 心理账户与框架效应

> 塞勒（Richard Thaler，2017 年诺贝尔经济学奖得主）问了一个朴素的问题：**100 块工资里的 100 块，和 100 块彩票赢来的 100 块，是同一张钱吗？** 理性人会说「是」，但现实中，绝大多数人花这两笔钱的方式完全不同。钱不都是钱——这就是「**<mark>心理账户</mark>**」；同一句话换个说法就能改变决策——这就是「**<mark>框架效应</mark>**」。两者是交易中「**<mark>止损</mark>**执行不下去」的深层心理学解释。
...
结合 01 篇的**<mark>损失厌恶</mark>**（痛苦约为收益的 2 倍）与本篇的框架效应，止损困难有三层：
...
- 【交易表现】盈利单拿利润加仓、浮盈回吐不心疼、大赚之后立刻做高风险单——**「<mark>赌场盈利效应</mark>」是交易员**<mark>爆仓</mark>**的经典前置情节。**

::: info 📖 对照实验直觉：市场不承认心理账户
...
::: warning ⚠️ 风险提示
本内容仅用于学习与研究，不构成任何投资建议。心理账户与框架效应是描述性规律：理解它们有助于设计更抗偏差的流程，但**任何「换框架」「切账户」的手段都不能消灭风险本身**——风险敞口是客观的，情绪包装只是让亏损显得「没那么疼」。请以 [07-交易系统篇](../trading-system/) 的**<mark>仓位</mark>**管理与风险预算为准绳。
:::
