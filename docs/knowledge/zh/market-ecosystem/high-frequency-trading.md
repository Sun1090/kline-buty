...
- 原理：同时挂出买单与卖单，赚买卖价差，与 [02-做市商与流动性.md](market-makers-liquidity.md) 中做市商一致；HFT 只是把「人工盯盘报价」换成了「机器微秒级调价」。
...
- HFT 撤单极快：**<mark>当行情逆转时，机器单在毫秒内消失</mark>**（见 [02-做市商与流动性.md](market-makers-liquidity.md) 的流动性黑洞），散户的**<mark>止损</mark>**单可能成交在远离预期的价位。
