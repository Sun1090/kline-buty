...
- 每天有 1-2 小时看盘时间的人。
- 懂基本技术分析（支撑压力、均线、K 线形态，见 [06-技术分析篇](../technical-analysis/)）。
...
- **门槛**：需要理解合约机制与资金费率，详见 [05-加密合约篇](../crypto-perpetuals/)。
...
- [01-现货交易基础.md](spot-basics.md)：订单类型、手续费结构，策略落地前的必修课。
- [07-交易系统篇/02-风险管理.md](../trading-system/risk-management.md)：仓位管理、止损与回撤控制。
- [03-期货篇/02-**<mark>保证金</mark>**杠杆与强平.md](../futures/margin-leverage-liquidation.md)：期现套利前必读，搞懂保证金。
- [06-技术分析篇/README.md](../technical-analysis/)：波段交易的技术面基础。
