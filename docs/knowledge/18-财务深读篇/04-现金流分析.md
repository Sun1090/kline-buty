...
**这家公司的真实状态是：利润是纸上的，现金在往外流，增长靠垫资堆出来的。** 若模式不变，应收账款最终变成坏账、存货最终减值，纸面利润会被一次性打回原形。**<mark>净利润 1 亿 + 经营现金流 −5 亿 = 公司在「账面盈利、实际失血」</mark>。**
...
| **<mark>失血型</mark>** | 经营现金流常年为负，且筹资现金流持续大额流入 | 烧钱不止、融资不断的公司 | **危险信号**：没有自我造血能力 |
...
FCF 是公司在满足再投资需求后**真正可自由支配的钱**：可以分红、还债、回购、并购。它是企业价值的终极来源——一家公司值多少钱，最终取决于它能产生多少**<mark>自由现金流</mark>**。
...
| 检查项 | 健康 | 危险 |
|---|---|---|
| 货币资金 vs 有息负债 | 现金充裕覆盖短债 | **<mark>存贷双高</mark>**（钱很多但借得更多） |
...
| 短期借款 vs 长期借款 | 期限错配风险：短债长投是**<mark>暴雷</mark>**前兆 |
...
::: warning ⚠️ 现实：同一公司能算出五种「合理价」
**给同一家公司，五个分析师用 <mark>DCF</mark> 能算出五种「合理价」，从低估到严重高估。** 参数都是拍出来的，DCF 的用处不是算出精确价格，而是：(1) 检验你对生意的理解；(2) 建立「**<mark>安全边际</mark>**」的参照系；(3) 反向验证：现价隐含了多乐观的假设？
:::
