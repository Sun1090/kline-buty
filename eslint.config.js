...
export default tseslint.config(
  ...
  { ignores: ['dist', 'node_modules', 'public/sw.js', '.vitepress', 'docs-site/.vitepress/dist', 'docs-site/.vitepress/.temp', 'docs-site/docs/knowledge', 'app-shell', '*-probe*.mjs', 'manual-accept.mjs', 'touch-probe-temp.mjs'] },
