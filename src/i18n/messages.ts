...
export const en: Messages = {
  ...
  trade: {
    ...
    market: 'Market',
    limit: 'Limit',
    limitHint: 'A limit order fills at the posted price with no slippage once the market touches it',
    makerFee: 'Maker fee %',
...
export const ja: Messages = {
  ...
  trade: {
    ...
    market: '成行',
    limit: '指値',
    limitHint: '指値注文は指定価格に到達するとスリッページなしで約定します',
    makerFee: 'メイカー手数料 %',
    pendingTitle: '出信中の注文',
...
export const ko: Messages = {
  ...
  trade: {
    ...
    market: '시장가',
    limit: '지정가',
    limitHint: '지정가 주문은 가격 도달 시 슬리피지 없이 지정가로 체결됩니다',
    makerFee: '메이커 수수료 %',
    pendingTitle: '미체결 주문',
...
export const es: Messages = {
  ...
  trade: {
    ...
    market: 'Mercado',
    limit: 'Límite',
    limitHint: 'Las órdenes límite se ejecutan al precio indicado, sin deslizamiento',
