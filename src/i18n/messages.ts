...
export const zh = {
  ...
  paper: { title: '交易流水', empty: '暂无成交——开仓后此处记录成交流水', open: '开仓', close: '平仓', long: '多', short: '空', clear: '清空', export: '导出 CSV', reset: '重置账户', resetConfirm: '确认重置模拟账户？余额将恢复为 10,000 并清空全部流水。', equity: '权益曲线' },
...
export const en: Messages = {
  ...
  paper: { title: 'Trade History', empty: 'No trades yet — open a position and fills will be logged here', open: 'Open', close: 'Close', long: 'Long', short: 'Short', clear: 'Clear', export: 'Export CSV', reset: 'Reset account', resetConfirm: 'Reset the paper account? Balance returns to 10,000 and all trades are cleared.', equity: 'Equity curve' },
...
export const ja: Messages = {
  ...
  paper: { title: '取引履歴', empty: '取引なし——ポジションを建てるとここに記録されます', open: '新規', close: '決済', long: 'ロング', short: 'ショート', clear: '消去', export: 'CSV 出力', reset: '口座リセット', resetConfirm: '口座をリセットしますか？残高は 10,000 に戻り、取引履歴はすべて消去されます。', equity: '資産曲線' },
...
export const ko: Messages = {
  ...
  paper: { title: '거래 내역', empty: '거래 없음——포지션을 열면 여기에 기록됩니다', open: '진입', close: '청산', long: '롱', short: '숏', clear: '지우기', export: 'CSV 내보내기', reset: '계정 초기화', resetConfirm: '모의 계정을 초기화할까요? 잔액이 10,000으로 돌아가고 거래 내역이 모두 지워집니다.', equity: '자산 곡선' },
...
export const es: Messages = {
  ...
  paper: { title: 'Historial de operaciones', empty: 'Sin operaciones: abre una posición y se registrará aquí', open: 'Abrir', close: 'Cerrar', long: 'Largo', short: 'Corto', clear: 'Borrar', export: 'Exportar CSV', reset: 'Restablecer cuenta', resetConfirm: '¿Restablecer la cuenta simulada? El saldo vuelve a 10,000 y se borran todas las operaciones.', equity: 'Curva de capital' },
