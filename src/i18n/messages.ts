...
export const zh = {
  ...
  ctx: { copyPrice: '复制价格', copyOhlc: '复制 OHLC', addAlert: '添加提醒', clearDrawings: '清空画线', confirmClear: '确认清空当前品种的全部画线？', copied: '已复制' },
...
export const en: Messages = {
  ...
  ctx: { copyPrice: 'Copy price', copyOhlc: 'Copy OHLC', addAlert: 'Add alert', clearDrawings: 'Clear drawings', confirmClear: 'Clear all drawings for this symbol?', copied: 'Copied' },
...
export const ja: Messages = {
  ...
  ctx: { copyPrice: '価格をコピー', copyOhlc: 'OHLC をコピー', addAlert: 'アラートを追加', clearDrawings: '描画を消去', confirmClear: 'この銘柄の描画をすべて消去しますか？', copied: 'コピーしました' },
...
export const ko: Messages = {
  ...
  ctx: { copyPrice: '가격 복사', copyOhlc: 'OHLC 복사', addAlert: '알림 추가', clearDrawings: '선 모두 지우기', confirmClear: '이 심볼의 모든 선을 지울까요?', copied: '복사됨' },
...
export const es: Messages = {
  ...
  ctx: { copyPrice: 'Copiar precio', copyOhlc: 'Copiar OHLC', addAlert: 'Añadir alerta', clearDrawings: 'Borrar dibujos', confirmClear: '¿Borrar todos los dibujos de este símbolo?', copied: 'Copiado' },
