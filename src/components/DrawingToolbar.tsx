...
export function DrawingToolbar({
  ...
  const { t } = useI18n()
  return (
    <div role="toolbar" aria-label={t('drawing.group')} className="scroll-toolbar" style={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'nowrap', overflowX: 'auto', flexShrink: 1, minWidth: 0 }}>
